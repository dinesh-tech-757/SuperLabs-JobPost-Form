...
//                     <td className="py-3 px-4">fhjhfjf</td>
//                     <td className="py-3 px-4">dkjdk</td>
//                     <td className="py-3 px-4">ddddddd</td>
...
const AddUsers = ({ onClose, onSubmit, editData }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
      axios
        .post(`http://localhost:3000/auth/register`, { username: userName, password: userCredit, email: userEmail })
        .then((res) => {
